package com.project.zaixianjiaoyu.http.cache;
...
class CacheHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_CACHE_NAME = "okhttp_cache.db";
    ...
    public CacheHelper() {
        super(MyOkhttp.getContext(), DB_CACHE_NAME, null, DB_CACHE_VERSION);
    }
