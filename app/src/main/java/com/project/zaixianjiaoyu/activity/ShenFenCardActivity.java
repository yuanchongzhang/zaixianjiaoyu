...
public class ShenFenCardActivity extends AppCompatActivity {
    ...
    private boolean checkGalleryPermission() {
        int ret = ActivityCompat.checkSelfPermission(ShenFenCardActivity.this, Manifest.permission
                .READ_EXTERNAL_STORAGE);
        if (ret != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ShenFenCardActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.id_card_front_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShenFenCardActivity.this, CameraActivity.class);
