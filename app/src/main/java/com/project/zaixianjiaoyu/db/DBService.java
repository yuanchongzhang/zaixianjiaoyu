package com.project.zaixianjiaoyu.db;
...
public class DBService {
    ...
    public DBService() {
        //连接数据库
//        db = SQLiteDatabase.openDatabase("/data/data/com.project.zaixianjiaoyu/databases/question.db", null, SQLiteDatabase.OPEN_READWRITE);
        db = SQLiteDatabase.openDatabase("/data/data/com.project.zaixianjiaoyu/databases/question.db", null, SQLiteDatabase.OPEN_READWRITE);
//        db=SQLiteDatabase.openOrCreateDatabase("/data/data/com.project.zaixianjiaoyu/databases/question.db",null);
